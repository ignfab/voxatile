...
- `value` (required): [Model value](ModelValues.md) to use.
...
- `keepExistingMetadata` (optional, default `false`): `false` to overwrite possibly existing data, `true` to keep existing metadata.
