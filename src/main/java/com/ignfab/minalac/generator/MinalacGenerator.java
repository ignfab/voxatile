...
public final class MinalacGenerator {
     ...
     */
    static void main(String[] args) throws GenerationFailedException, InterruptedException, JsonProcessingException, MapWriteException, ParseException, TaskFailedException, TimeoutException {
