...
import com.ignfab.minalac.generator.outputs.lego.LegoWorld;
...
import com.ignfab.minalac.generator.parameters.placeables.voxels.LegoBrickParams;
...
public final class MinalacGenerator {
    ...
    public static void main(String[] args) throws FactoryException, InterruptedException, MapWriteException, ParseException, TaskFailedException, TransformException, JsonProcessingException, GenerationFailedException {
        ...
        parser.registerFormat("lego", new OutputFormat(() -> new LegoWorld(destination), LegoBrickParams.class, LegoBrickParams::new));
        ...
        parser.registerParams("setHeightmap", SetHeightmapTaskParams.class);
