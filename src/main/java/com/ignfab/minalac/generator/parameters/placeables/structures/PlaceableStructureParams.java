...
public final class PlaceableStructureParams extends PlaceableParams {
    ...
    /**
     * Creates a {@link PlaceableStructure} according to parameters.
     *
     * @param world VoxelWorld into structure will be placed
     * @return the created structure
     */
    public PlaceableStructure create(VoxelWorld world) {
        PlaceableStructure structure = new PlaceableStructure();
        for (Variant param : params) {
            param.apply(world, structure);
        }
    ...
    public static class Deserializer extends JsonDeserializer<PlaceableStructureParams> {
        ...
        public PlaceableStructureParams deserialize(JsonParser jp, DeserializationContext ctxt)
            ...
            if (node.isObject()) {
                ...
                return new PlaceableStructureParams(Collections.singletonList(structure));
            }
    ...
    /**
     * Abstract class for all strucutre parameters variants.
     */
    ...
    public abstract static class Variant {
         ...
         *
         * Is is used rather than a {@code create} method to allow merging several parameters into one structure.
         *
         * @param world Voxel world which create used voxels for
         * @param structure Structure which put created voxels into
         */
        public abstract void apply(VoxelWorld world, PlaceableStructure structure);
    }
}
