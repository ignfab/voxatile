...
public class StructureLayoutBuilderParams implements LayoutBuilderParams {
    ...
    public LayoutBuilder createBuilder(Seed seed, AxesPolicies policies) throws UnbuildableLayoutException {
        ...
        return new StructureLayoutBuilder(
            structure,
    ...
    public static class StretchAxisParams {
        ...
        /**
         * Creates corresponding {@link StructureLayoutBuilder.StretchAxis}.
         *
         * @param axis axis to create
         * @return created {@link StructureLayoutBuilder.StretchAxis}
         */
        public StructureLayoutBuilder.StretchAxis create(Axis axis) {
            return new StructureLayoutBuilder.StretchAxis(axis, at, atLeast, atMost);
        }
    }

    /**
     * Non stretchable stretch axis params.
     */
