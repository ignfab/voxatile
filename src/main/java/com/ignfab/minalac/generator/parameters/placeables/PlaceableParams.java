...
public abstract class PlaceableParams {
     ...
     *
     * This deserializer is able to perform serialization in three different ways:
     * 1 - If value is a string, uses the "shortcut" way, using {@code createVoxelTypeParams} format method.
     * 2 - If value is an object without {@code type} attribute, perform "default" deserialization, using the other form of {@code createVoxelTypeParams} format method.
     * 3 - Deserialize object using Jackson typeinfo mechanism.
     */
