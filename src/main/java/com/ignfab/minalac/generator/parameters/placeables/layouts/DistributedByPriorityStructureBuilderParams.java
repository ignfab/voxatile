...
import com.ignfab.minalac.generator.placeables.builders.DefaultAxisStructureBuilder;
...
public class DistributedByPriorityStructureBuilderParams extends AxisStructureBuilderParams {
    ...
    public AxisStructureBuilder create(Seed seed) {
        AxisStructureBuilder[] builders = new AxisStructureBuilder[distributedByPriority.size()];
        ...
        return DefaultAxisStructureBuilder.priority(builders, axis.create(), priorities);
    }

    public static class PriorityStructureBuilderParams {
        public AxisStructureBuilderParams builder;
        public int priority;
    }
}
