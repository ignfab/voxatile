            ...
            CompoundTag data = new CompoundTag();
            {
                ...
                CompoundTag player = new CompoundTag();
                {
                    ...
                    ListTag<DoubleTag> pos = new ListTag<>(DoubleTag.class);
                    {
                        ...
                        pos.addDouble(Math.clamp(metadata.getSpawn().z(), limits().minZ(), limits().maxZ()));
                ...
                data.putInt("SpawnY", Math.clamp(metadata.getSpawn().z(), limits().minZ(), limits().maxZ()));
