...
public class Polygon2dIterator implements Iterator<Positioned2d> {
     ...
     *
     * @param line Line to compute intersections with hotizontal axis
    ...
    public static Intersection intersection(Line2d line, int y) {
        // No intersection
    ...
    // En fait ici, tout était fait pour ressembler à l'itérateur border simple. Si on le fait sauter, ça n'a plus forcément de sens.
