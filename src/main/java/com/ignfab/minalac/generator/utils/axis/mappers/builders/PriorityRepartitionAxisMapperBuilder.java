...
public class PriorityRepartitionAxisMapperBuilder implements AxisMapperBuilder {
    ...
    public int maxSizeUnder(int size) {
        if (size < minimalSize)
            return -1;
        // TODO-PR-Facade-OLD : Initialement j'vais mis ce test car c'était un espece de copié-collé de l'equaliseur ou on peutt pas faire une division par zero pour connaitre le nombre de sous-segment
