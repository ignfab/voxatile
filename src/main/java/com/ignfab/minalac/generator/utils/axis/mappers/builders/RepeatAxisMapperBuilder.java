...
public class RepeatAxisMapperBuilder implements AxisMapperBuilder {
    ...
    public AxisMapper build(int size) throws UnbuildableException {
        ...
        // TODO-PR-Facade-OLD : Initialement j'avais mis que si la talle minimale de underlying était de 0 alors le build était de 0.
    ...
    // TODO-PR-Facade: A fix was done when maxOccur is bellow size / underlying. Tests should into account other possible edge cases
