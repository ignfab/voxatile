...
public record Vector2d(double x, double y) {
     ...
     */
    public static final Vector2d ZERO = new Vector2d(0, 0); // Spécific class ?
   ...
   /**
    ...
    /**
     * Rounds that vector into a new {@link WorldCoords2d}.
     *
    ...
    /**
     * Computes the normal of this vector as a new vector.
     *
    ...
    public String toString() {
        return "%s(%f, %f)".formatted(this.getClass().getSimpleName(), x, y);
    }
