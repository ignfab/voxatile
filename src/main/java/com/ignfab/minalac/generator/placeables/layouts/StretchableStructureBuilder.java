...
// TODO-PR-Facade: There is probably a better way to do it. This is to lock stretchable ability to only PlaceableStructure.
...
public class StretchableStructureBuilder implements LayoutBuilder {
    ...
    public Structure build(int sizeX, int sizeY, int sizeZ) throws UnbuildableException {
        // TODO-PR-Facade: For now, redondant with DefaultLayoutStructure
        ...
        // TODO-PR-Facade: Should not happen as either Constant or Stretch have a length of 1
