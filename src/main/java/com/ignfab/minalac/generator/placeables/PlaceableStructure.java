...
import com.ignfab.minalac.generator.placeables.work_in_progress.builder.ConstantIndexMapperBuilder;
...
public final class PlaceableStructure implements Structure {
    ...
    public Placeable get(int x, int y, int z) {
        return placeables.getOrDefault(new WorldCoords3d(x, y, z), Nothing.INSTANCE);
    }
