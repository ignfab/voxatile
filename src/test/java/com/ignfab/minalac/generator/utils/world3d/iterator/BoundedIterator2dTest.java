...
public class BoundedIterator2dTest {
    ...
    void test() {
        ...
        IteratorTester.assertBrowsesAllOnce(
            ...
            new BoundedIterator3d<>(list.iterator(), new WorldBBox3d(2, 4, 6, 5, 4, 3))
        );

        IteratorTester.assertBrowsesAllOnce(
            Collections.emptyList(),
            new BoundedIterator3d<>(list.iterator(), new WorldBBox3d(-2, -4, -5, 1, 3, 5))
        );

        IteratorTester.assertBrowsesAllOnce(
            Collections.emptyList(),
            new BoundedIterator3d<>(list.iterator(), WorldBBox3d.EMPTY)
        );
    }
}
