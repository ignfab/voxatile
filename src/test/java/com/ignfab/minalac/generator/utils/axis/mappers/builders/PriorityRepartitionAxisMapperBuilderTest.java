...
public class PriorityRepartitionAxisMapperBuilderTest {
    ...
    public void testMaxSizeUnderDistribution() {
        ...
        // The exact results are implementation dependant.
        // However, what we want to test is that the PriorityRepartitionAxisMapperBuilder:
        //  - Tries to distribute to have an roughly equals distribution
        //  - Tries to leave no starved segments when possible
        ...
        AxisMapperBuilder fiveFourThreeBuilder = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(0, 5, 10, 15, 20),
                    new AllowlistTestingAxisMapperBuilder(0, 4, 8, 12, 16, 20),
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9, 12, 15)
                },
                new int[] { 0, 0, 0 }
            )
        );
        assertTrue(fiveFourThreeBuilder.maxSizeUnder(48) >= 40);
        int resultingSize = fiveFourThreeBuilder.maxSizeUnder(48);

        int[] intervals = assertDoesNotThrow(() -> fiveFourThreeBuilder.build(resultingSize).intervals());
        assertTrue(14 <= intervals[0]);
        assertTrue(14 <= intervals[1]);
        assertTrue(14 <= intervals[2]);


        // The middle builder has a minimal size, we test that it doesn't get greedy
        // Basically the repartition should be fair despite minimal size
        AxisMapperBuilder noGreedTwo = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9),
                    new AllowlistTestingAxisMapperBuilder(2, 4, 6),
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9)
                },
                new int[] { 0, 0, 0 }
            )
        ...
        // Three has min size
        AxisMapperBuilder noGreedThree = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(3, 6, 9),
                    new AllowlistTestingAxisMapperBuilder(0, 2, 4, 6),
                    new AllowlistTestingAxisMapperBuilder(3, 6, 9)
                },
                new int[] { 0, 0, 0 }
            )
        ...
        assertEquals(8, noGreedThree.maxSizeUnder(8));
        AxisMapper noGreedThreeMapper = assertDoesNotThrow(() -> noGreedThree.build(8));
        assertArrayEquals(new int[] { 3, 2, 3 }, noGreedThreeMapper.intervals());

        // The tests below are almost the same as noGreed but with no minimal size
        // Tested with various order
        // 3 - 2 - 3
        AxisMapperBuilder threeTwoThree = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9),
                    new AllowlistTestingAxisMapperBuilder(0, 2, 4, 6),
        ...
        assertEquals(8, threeTwoThree.maxSizeUnder(8));
        AxisMapper threeTwoThreeMapper = assertDoesNotThrow(() -> threeTwoThree.build(8));
        assertArrayEquals(new int[] { 3, 2, 3 }, threeTwoThreeMapper.intervals());

        // 3 - 3 - 2
        AxisMapperBuilder threeThreeTwo = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9),
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9),
        ...
        assertEquals(8, threeThreeTwo.maxSizeUnder(8));
        AxisMapper threeThreeTwoMapper = assertDoesNotThrow(() -> threeThreeTwo.build(8));
        assertArrayEquals(new int[] { 3, 3, 2 }, threeThreeTwoMapper.intervals());

        // 2 - 3 - 3
        AxisMapperBuilder twoThreeThree = assertDoesNotThrow(
            () -> new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new AllowlistTestingAxisMapperBuilder(0, 2, 4, 6),
                    new AllowlistTestingAxisMapperBuilder(0, 3, 6, 9),
        ...
        assertEquals(8, twoThreeThree.maxSizeUnder(8));
        AxisMapper twoThreeThreeMapper = assertDoesNotThrow(() -> twoThreeThree.build(8));
        assertArrayEquals(new int[] {2, 3, 3}, twoThreeThreeMapper.intervals());
    }
    ...
    public void testMaxSizeUnderBuild() {
        ...
        AxisMapperBuilder minSizeError = assertDoesNotThrow(
            () ->  new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new RangeTestingAxisMapperBuilder(2, 5),
                    new RangeTestingAxisMapperBuilder(0),
                    new RangeTestingAxisMapperBuilder(6, 7)
                },
                new int[] { 0, 0, 0 }
            )
        );
        assertEquals(-1, minSizeError.maxSizeUnder(7));
        assertThrows(UnbuildableLayoutException.class, () -> minSizeError.build(7));

        AxisMapperBuilder minZero = assertDoesNotThrow(
            () ->  new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new RangeTestingAxisMapperBuilder(0, 4),
                    new RangeTestingAxisMapperBuilder(0, 4)
                },
                new int[] { 0, 0 }
            )
        ...
        AxisMapperBuilder samePrio = assertDoesNotThrow(
            () ->  new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    ...
                    new RangeTestingAxisMapperBuilder(3)
                },
                new int[] { 0, 0 }
            )
        );
        ...
        AxisMapperBuilder builderWithOnePrio = assertDoesNotThrow(
            () ->  new PriorityRepartitionAxisMapperBuilder(
                new AxisMapperBuilder[] {
                    new RangeTestingAxisMapperBuilder(0, 8),
                    new RangeTestingAxisMapperBuilder(2, 4)
                },
                new int[] { 1, 0 }
            )
        );
    ...
    public void testMinimumSize() {
        assertEquals(
            ...
            assertDoesNotThrow(
                () ->  new PriorityRepartitionAxisMapperBuilder(
                    new AxisMapperBuilder[] {
                        new RangeTestingAxisMapperBuilder(2, 5),
                        new RangeTestingAxisMapperBuilder(0), new RangeTestingAxisMapperBuilder(6, 7)
                    },
                    new int[] { 0, 1, 0 }
                )
            ).minimumSize()
        ...
        assertEquals(
            ...
            assertDoesNotThrow(
                () ->  new PriorityRepartitionAxisMapperBuilder(
                    new AxisMapperBuilder[] {
                        new RangeTestingAxisMapperBuilder(0, 5),
                        new RangeTestingAxisMapperBuilder(0),
                        new RangeTestingAxisMapperBuilder(0, 4)
                    },
                    new int[] { 1, 0, 0 }
