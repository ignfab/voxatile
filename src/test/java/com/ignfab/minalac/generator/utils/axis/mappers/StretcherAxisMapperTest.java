...
public class StretcherAxisMapperTest {
    ...
    public void testConstructor() {
        assertThrows(IllegalArgumentException.class, () -> new StretcherAxisMapper(0, 0, 2, -1), "negative length");
        assertThrows(IllegalArgumentException.class, () -> new StretcherAxisMapper(0, 0, -1, 1), "negative base length");
        assertThrows(IllegalArgumentException.class, () -> new StretcherAxisMapper(0, 0, 3, 1), "Squeezed more than once");
        assertThrows(IllegalArgumentException.class, () -> new StretcherAxisMapper(0, 4, 2, 2), "stretch out of size");
    }

    @Test
    public void testMap() {
        AxisMapper same = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 1, 3, 3));
        ...
        AxisMapper stretched = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 1, 3, 5));
        ...
        AxisMapper squeezedSecondWithOffset = assertDoesNotThrow(() -> new StretcherAxisMapper(4, 5, 3, 2));
        ...
        AxisMapper squeezedFirstWithOffset = assertDoesNotThrow(() -> new StretcherAxisMapper(4, 4, 3, 2));
        ...
        AxisMapper zeroSize = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 0, 1, 0));
        assertThrows(IndexOutOfBoundsException.class, () -> zeroSize.map(0));
    }

    @Test
    public void testIntervalsAndSize() {
        AxisMapper same = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 0, 3, 3));
        assertArrayEquals(new int[] { 3 }, same.intervals());
        assertEquals(3, same.size());

        AxisMapper stretched = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 0, 3, 5));
        assertArrayEquals(new int[] { 3 }, stretched.intervals());
        assertEquals(5, stretched.size());

        AxisMapper squeezed = assertDoesNotThrow(() -> new StretcherAxisMapper(0, 0, 3, 2));
