...
public class RepeatAxisMapperBuilderTest {
    ...
    public void testMaxSizeUnder() {
        ...
        assertEquals(14, assertDoesNotThrow(
            () -> new RepeatAxisMapperBuilder(new RangeTestingAxisMapperBuilder(7), 2, 2).maxSizeUnder(25))
        );
        // Max under 14 is 2 * 7 = 14
        assertEquals(14, assertDoesNotThrow(
            () -> new RepeatAxisMapperBuilder(new RangeTestingAxisMapperBuilder(7), 2, 2).maxSizeUnder(14))
        );
