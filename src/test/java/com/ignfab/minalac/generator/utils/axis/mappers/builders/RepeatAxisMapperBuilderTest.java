...
public class RepeatAxisMapperBuilderTest {
    ...
    public void testMaxSizeUnder() {
        ...
        // TODO-PR-Facade: Dans la continuité des tests sur maximum occur. Peut-être revenir sur ça (Ca peut devenir compliqué car deux sources de variations de taille)
