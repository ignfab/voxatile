...
public class StackStructureParamsTest {
    ...
    void testDeserializeEmptyStack() {
        ...
        assertEquals(null, params.layers);
    ...
    void testDeserializeDownwardsStack() {
        ...
        assertInstanceOf(TestingVoxelTypeParams.class, params.layers.get(0).material);
        assertEquals("a", ((TestingVoxelTypeParams) params.layers.get(0).material).type);
        assertEquals(3, params.layers.get(1).height);
        assertInstanceOf(TestingVoxelTypeParams.class, params.layers.get(1).material);
        assertEquals("b", ((TestingVoxelTypeParams) params.layers.get(1).material).type);
    ...
    void testDeserializeUpwardsStack() {
        ...
        assertEquals(1, params.layers.get(0).height);
        assertInstanceOf(TestingVoxelTypeParams.class, params.layers.get(0).material);
        assertEquals("c", ((TestingVoxelTypeParams) params.layers.get(0).material).type);
        assertEquals(2, params.layers.get(1).height);
        assertInstanceOf(TestingVoxelTypeParams.class, params.layers.get(1).material);
        assertEquals("b", ((TestingVoxelTypeParams) params.layers.get(1).material).type);
        assertEquals(1, params.layers.get(2).height);
        assertInstanceOf(TestingVoxelTypeParams.class, params.layers.get(2).material);
        assertEquals("a", ((TestingVoxelTypeParams) params.layers.get(2).material).type);
