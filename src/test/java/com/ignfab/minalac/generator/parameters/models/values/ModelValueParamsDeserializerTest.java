...
public class ModelValueParamsDeserializerTest {
    ...
    @Test
    @DisplayName("Test model value deserialization using 'null' value")
    public void testModelValueParamsDeserializerAbsent() {
        ModelValueParams params = assertDoesNotThrow(() -> ParamsTester.deserialize(ModelValueParams.class, "null"));
