...
public class SequenceTaskParamsTest {
    ...
    public void testFlatten() {
        ...
        assertPredecessor(tasks, "test:#1", "test:#2");
        assertPredecessor(tasks, "test:#2", "test:#3");
        ...
        assertPredecessor(tasks, "test:#1", "test:#2:#1");
        assertPredecessor(tasks, "test:#2:#1", "test:#2:#2");
        assertPredecessor(tasks, "test:#2:#2", "test:#2:#3");
        assertPredecessor(tasks, "test:#2:#3", "test:#3");
    }
    ...
    public void testFlattenAfter() {
        ...
        assertValidSchedule(tasks);
        assertPredecessor(tasks, "test:sequence:#2", "test:last");
        assertPredecessor(tasks, "test:first", "test:sequence:#1");
        assertNotPredecessor(tasks, "test:other", "test:sequence:#1");
        assertNotPredecessor(tasks, "test:sequence:#2", "test:other");
    }
    ...
    public void testFlattenUsing() {
        ...
        assertValidSchedule(tasks);
        assertPredecessor(tasks, "main:task", "main:sequence:#3", "main:sequence:#2:#2");
        assertNotPredecessor(tasks, "main:task", "main:sequence:#2:#1", "main:sequence:#1");
        assertNotPredecessor(tasks, "main:sequence:#3", "main:sequence:#2:#2", "main:sequence:#3");
    }
