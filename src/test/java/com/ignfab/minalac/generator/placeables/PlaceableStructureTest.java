...
public class PlaceableStructureTest {
    ...
    public void testPlace() {
        TestingVoxelWorldTile tile = new TestingVoxelWorldTile(new WorldBBox3d(-1, -2, -3, 3, 3, 3));
    ...
    public void testPlaceWithEmptyStructure() {
        TestingVoxelWorldTile tile = new TestingVoxelWorldTile(new WorldBBox3d(3, 4, 5, 2, 1, 1));
