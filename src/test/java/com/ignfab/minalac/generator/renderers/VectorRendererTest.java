...
class VectorRendererTest {
    ...
    public void testConstructor() {
        assertDoesNotThrow(() -> new VectorRenderer(new Seed(""), modelSelection, heightmap, inside, edge));
    }
    ...
    public void testRenderFlat() {
        ...
        new VectorRenderer(new Seed(""), modelSelection, heightmap, inside, edge).render(bbox);
